...
var getOwnPropertyNamesExternal = __webpack_require__(90);
...
function relativeCost(current, low, high) {
  var exponent = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 1.4;

  //The better the technology, the more disproportionate it's cost to include.
  if (!(current >= low && current <= high)) {
    throw "Was not low<=current<=high";
  }

  var lowRes = Math.pow(low, exponent);
  var currentRes = Math.pow(current, exponent);
  var highRes = Math.pow(high, exponent);
  console.log(lowRes, currentRes, highRes);
  var ratio = (currentRes - lowRes) / (highRes - lowRes);
  return ratio;
}

module.exports = {
  loadAssetJSON: loadAssetJSON,
...
var global = __webpack_require__(0);
var getBuiltIn = __webpack_require__(9);
var NativePromise = __webpack_require__(70);
var redefine = __webpack_require__(13);
...
var hostReportErrors = __webpack_require__(82);
  ...
  return regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return fetch("packages/assets.json");
        ...
        case 5:
          window.jsonAssets = _context.sent;
          Battery = __webpack_require__(87);
          FuelTank = __webpack_require__(94);
          Reactor = __webpack_require__(95);
...
var assets = utils.loadAssetJSON("Energy/Battery.js");
...
var Battery = /*#__PURE__*/function () {
  ...
  _createClass(Battery, null, [{
    key: "getDesignWeight",
    value: function getDesignWeight() {
      var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var levelData = Battery.levels[config.level - 1];

      if (levelData === undefined) {
        throw "Invalid config.level: " + config.level;
      }

      var ratio = utils.relativeCost(config.capacity, levelData.capacity[0], levelData.capacity[1]);
      var weight = levelData.weight[0] + ratio * (levelData.weight[1] - levelData.weight[0]);
      return weight;
    }
  }]);
...
_defineProperty(Battery, "description", assets.description);

_defineProperty(Battery, "levels", assets.levels);
...
var assets = utils.loadAssetJSON("Energy/FuelTank.js");

var FuelTank = /*#__PURE__*/function () {
  "use strict";
  ...
  _createClass(FuelTank, null, [{
    key: "getDesignWeight",
    value: function getDesignWeight() {
      var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var levelData = FuelTank.levels[config.level - 1];
...
_defineProperty(FuelTank, "description", assets.description);

_defineProperty(FuelTank, "levels", assets.levels);
...
var assets = utils.loadAssetJSON("Energy/Reactor.js");
...
var Reactor = /*#__PURE__*/function () {
  ...
  _createClass(Reactor, null, [{
    ...
    value: function getDesignWeight() {
      var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var levelData = Reactor.levels[config.level - 1];
      ...
      var ratio = utils.relativeCost(config.reactionSpeed, levelData.reactionSpeed[0], levelData.reactionSpeed[1]);
      console.log(ratio);
      var weight = levelData.weight[0] + ratio * (levelData.weight[1] - levelData.weight[0]);
      return weight;
    }
...
_defineProperty(Reactor, "description", assets.description);

_defineProperty(Reactor, "levels", assets.levels);
